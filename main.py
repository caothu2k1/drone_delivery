...
if __name__ == "__main__":
    ...
    parser.add_argument("--vehicle_port", type= str, help="Vehicle port", default='/dev/ttyACM0')
    parser.add_argument("--model_path", type=str, help="Model path", default='./models/yolov8n_ncnn_model')
